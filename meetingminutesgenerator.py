...
Original file is located at
    https://colab.research.google.com/drive/1D-NNuFGT_Q32A5GXD0bdD5XnjTjIq5GG
"""
...
#User Inputs
meeting_title=input("Enter meeting_title: ")
date=input("Enter meeting_date (DD-MM-YYYY): ")
time=input("Enter meeting_time : ")
...
actions_items=input("Enter action items (comma separated): ") # Added this line
...
print("\nFilesaved as meeting_minutes.csv")